  ...
  return (
    ...
    >
      ...
      <div className="mt-8 pt-8 border-t border-slate-200">
        ...
        >
          <div>
            <p className="text-sm font-semibold text-slate-900 mb-1 group-hover:text-slate-700 transition-colors">LTV:CAC Analyser</p>
            <p className="text-sm text-slate-500">High returns cost eats into contribution margin. Check whether your acquisition economics still hold.</p>
          </div>
